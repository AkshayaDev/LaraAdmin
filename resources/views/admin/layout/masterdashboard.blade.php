  ...
  <div class=" container-scroller">
    ...
    <nav class="navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="bg-white text-center navbar-brand-wrapper">
        ...
        <a class="navbar-brand brand-logo-mini" href="../../index.html"><img src="{{ asset('assets/admin/images/logo_star_mini.jpg') }}" alt=""></a>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <ul class="navbar-nav ml-lg-auto d-flex align-items-center flex-row">
          <li class="nav-item">
            <a class="nav-link profile-pic" href="#"><img class="rounded-circle" src="{{ asset('assets/admin/images/face.jpg') }}" alt=""></a>
          </li>
          <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../../pages/icons/index.html">
                <img src="{{ asset('assets/admin/images/icons/7.png') }}" alt="">
                <span class="menu-title">Icons</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../../pages/ui-elements/typography.html">
                <img src="{{ asset('assets/admin/images/icons/8.png') }}" alt="">
                <span class="menu-title">Typography</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#sample-pages" aria-expanded="false" aria-controls="sample-pages">
                <img src="{{ asset('assets/admin/images/icons/9.png') }}" alt="">
